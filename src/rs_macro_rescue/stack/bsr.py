...
from rs_macro_rescue.stack.haa_stack import make_haa_policy
from rs_macro_rescue.stack.repair import set_candidate, watchdog_evidence
from rs_macro_rescue.stack.bsr_common import BaseCX28Policy, CX27WatchdogConfig, build_frozen_haa_stack
...
def build_nonholonomic_field(case: dict[str, Any], predictor, cfg: CXGlobalConfig, params: CX33BBSRParams, memory: dict[str, Any] | None = None) -> np.ndarray:
    from rs_macro_rescue.stack import haa_policy as base_mod
