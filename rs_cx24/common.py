...
from rs_cx11.common import SupportBand, fit_support_band, support_match, TreeNode, fit_tree, predict_tree, tree_to_dict
...
FROZEN_CHOSEN_JSON = Path('outputs/rs_p0cx23_c_pilot_v1/chosen.json')
...
def load_frozen_haa_params(chosen_json: Path = FROZEN_CHOSEN_JSON) -> haa_mod.CX23CHAAParams:
    data = json.loads(Path(chosen_json).read_text(encoding='utf-8'))
    return haa_mod.CX23CHAAParams(**data['params'])
