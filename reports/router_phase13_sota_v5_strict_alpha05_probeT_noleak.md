...
## Artifacts
- `seed_metrics_csv`: `paper/tables_router_v12_strict_alpha05_probeT_noleak/table_phase13_seed_metrics.csv`
- `benchmark_direction_csv`: `paper/tables_router_v12_strict_alpha05_probeT_noleak/table_phase13_benchmark_direction.csv`
- `significance_csv`: `paper/tables_router_v12_strict_alpha05_probeT_noleak/table_phase13_significance.csv`
- `strongest_counts_csv`: `paper/tables_router_v12_strict_alpha05_probeT_noleak/table_phase13_strongest_baseline_counts.csv`
- `external_sota_summary_csv`: `paper/tables_router_v12_strict_alpha05_probeT_noleak/table_phase13_external_sota_summary.csv`
- `report_md`: `reports/router_phase13_sota_v5_strict_alpha05_probeT_noleak.md`