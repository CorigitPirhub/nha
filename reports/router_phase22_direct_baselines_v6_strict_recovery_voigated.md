...
## Artifacts
- `out_dir`: `outputs/router_phase22_direct_baselines_v6_strict_recovery_voigated`
- `seed_metrics_csv`: `outputs/router_phase22_direct_baselines_v6_strict_recovery_voigated/tables/seed_metrics.csv`
- `method_summary_csv`: `outputs/router_phase22_direct_baselines_v6_strict_recovery_voigated/tables/method_summary.csv`
- `significance_csv`: `outputs/router_phase22_direct_baselines_v6_strict_recovery_voigated/tables/significance.csv`
- `paper_table_csv`: `paper/tables_router_v13_strict_recovery_voigated/table_phase22_direct_baselines.csv`
- `report_md`: `reports/router_phase22_direct_baselines_v6_strict_recovery_voigated.md`
