...
## Artifacts
- `outputs/router_phase9_bench_v6_strict_knapsack/router_eval/stats.json`
- `outputs/router_phase9_bench_v6_strict_knapsack/router_eval/seed_runs.csv`
- `outputs/router_phase9_bench_v6_strict_knapsack/router_eval/seeds`