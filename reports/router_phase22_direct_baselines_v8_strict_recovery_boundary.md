...
- `J_improve_mean`: `-0.000%`
- `risk_delta_mean_pct`: `0.000`
- `pooled_delta_j_ci95`: `[-7.076478146420576e-06, -1.240598777607777e-06]`
...
## Artifacts
- `out_dir`: `outputs/router_phase22_direct_baselines_v8_strict_recovery_boundary`
- `seed_metrics_csv`: `outputs/router_phase22_direct_baselines_v8_strict_recovery_boundary/tables/seed_metrics.csv`
- `method_summary_csv`: `outputs/router_phase22_direct_baselines_v8_strict_recovery_boundary/tables/method_summary.csv`
- `significance_csv`: `outputs/router_phase22_direct_baselines_v8_strict_recovery_boundary/tables/significance.csv`
- `paper_table_csv`: `paper/tables_router_v15_strict_recovery_boundary/table_phase22_direct_baselines.csv`
- `report_md`: `reports/router_phase22_direct_baselines_v8_strict_recovery_boundary.md`
