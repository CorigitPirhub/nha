...
## Artifacts
- `out_dir`: `outputs/router_phase22_direct_baselines_v10_strict_weighted_tree_p`
- `seed_metrics_csv`: `outputs/router_phase22_direct_baselines_v10_strict_weighted_tree_p/tables/seed_metrics.csv`
- `method_summary_csv`: `outputs/router_phase22_direct_baselines_v10_strict_weighted_tree_p/tables/method_summary.csv`
- `significance_csv`: `outputs/router_phase22_direct_baselines_v10_strict_weighted_tree_p/tables/significance.csv`
- `paper_table_csv`: `paper/tables_router_v25_strict_weighted_tree_p/table_phase22_direct_baselines.csv`
- `report_md`: `reports/router_phase22_direct_baselines_v10_strict_weighted_tree_p.md`
