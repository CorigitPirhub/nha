...
## Artifacts
- `outputs/router_phase9_bench_v9_strict_recovery_risktrade/router_eval/stats.json`
- `outputs/router_phase9_bench_v9_strict_recovery_risktrade/router_eval/seed_runs.csv`
- `outputs/router_phase9_bench_v9_strict_recovery_risktrade/router_eval/seeds`