...
- output root: `outputs/rs_p0cx41_a_pilot_v1`
...
- `CX41-A (Full)`: success_delta_pp=`0.000`, exp_delta=`0.000`, mean_time_overhead_ratio=`0.598055`
- `CX41-A (No-Depth2-Escalation)`: success_delta_pp=`0.000`, exp_delta=`0.000`, mean_time_overhead_ratio=`0.596454`
- `CX41-A (No-Substrate-Quotient)`: success_delta_pp=`0.000`, exp_delta=`0.000`, mean_time_overhead_ratio=`0.264589`
...
- `alpha_puzzle` / `CX41-A (Full)`: exp_delta=`0.000`, mean_time_overhead_ratio=`0.526539`
- `alpha_puzzle` / `CX41-A (No-Depth2-Escalation)`: exp_delta=`0.000`, mean_time_overhead_ratio=`0.523939`
- `alpha_puzzle` / `CX41-A (No-Substrate-Quotient)`: exp_delta=`0.000`, mean_time_overhead_ratio=`0.357424`
...
- `bug_trap` / `CX41-A (Full)`: exp_delta=`0.000`, mean_time_overhead_ratio=`0.603511`
- `bug_trap` / `CX41-A (No-Depth2-Escalation)`: exp_delta=`0.000`, mean_time_overhead_ratio=`0.589245`
- `bug_trap` / `CX41-A (No-Substrate-Quotient)`: exp_delta=`0.000`, mean_time_overhead_ratio=`0.309065`
...
- `flange` / `CX41-A (Full)`: exp_delta=`0.000`, mean_time_overhead_ratio=`0.585131`
- `flange` / `CX41-A (No-Depth2-Escalation)`: exp_delta=`0.000`, mean_time_overhead_ratio=`0.583406`
- `flange` / `CX41-A (No-Substrate-Quotient)`: exp_delta=`0.000`, mean_time_overhead_ratio=`0.266381`
...
- `maze` / `CX41-A (Full)`: exp_delta=`0.000`, mean_time_overhead_ratio=`0.638316`
- `maze` / `CX41-A (No-Depth2-Escalation)`: exp_delta=`0.000`, mean_time_overhead_ratio=`0.637265`
- `maze` / `CX41-A (No-Substrate-Quotient)`: exp_delta=`0.000`, mean_time_overhead_ratio=`0.278339`
...
- `narrow_passage` / `CX41-A (Full)`: exp_delta=`0.000`, mean_time_overhead_ratio=`0.610046`
- `narrow_passage` / `CX41-A (No-Depth2-Escalation)`: exp_delta=`0.000`, mean_time_overhead_ratio=`0.608259`
- `narrow_passage` / `CX41-A (No-Substrate-Quotient)`: exp_delta=`0.000`, mean_time_overhead_ratio=`0.263208`
...
- `parasol_misc` / `CX41-A (Full)`: exp_delta=`0.000`, mean_time_overhead_ratio=`0.637991`
- `parasol_misc` / `CX41-A (No-Depth2-Escalation)`: exp_delta=`0.000`, mean_time_overhead_ratio=`0.638994`
- `parasol_misc` / `CX41-A (No-Substrate-Quotient)`: exp_delta=`0.000`, mean_time_overhead_ratio=`0.255796`
