...
## Artifacts
- `outputs/router_phase9_bench_v3_strict/router_eval/stats.json`
- `outputs/router_phase9_bench_v3_strict/router_eval/seed_runs.csv`
- `outputs/router_phase9_bench_v3_strict/router_eval/seeds`