...
## Artifacts
- `outputs/router_phase9_bench_v8_strict_recovery_voigated/router_eval/stats.json`
- `outputs/router_phase9_bench_v8_strict_recovery_voigated/router_eval/seed_runs.csv`
- `outputs/router_phase9_bench_v8_strict_recovery_voigated/router_eval/seeds`