...
from rs_cx11.common import SupportBand, TreeNode, fit_support_band, fit_tree, predict_tree, support_match, tree_to_dict
from rs_cx22 import cx22_d_sha as sha_mod
...
FROZEN_CHOSEN_JSON = Path('outputs/rs_p0cx22_d_pilot_v1/chosen.json')
...
def load_frozen_shadow_params(chosen_json: Path = FROZEN_CHOSEN_JSON) -> sha_mod.CX22DSHAParams:
    data = json.loads(Path(chosen_json).read_text(encoding='utf-8'))
    return sha_mod.CX22DSHAParams(**data['params'])
